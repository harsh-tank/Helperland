...
class DashboardRepository {
    ...
    rescheduleSR(date, time, srId) {
        return __awaiter(this, void 0, void 0, function* () {
            return index_1.db.ServiceRequest.update({ ServiceStartDate: date, ServiceStartTime: time }, { where: { ServiceRequestId: srId } });
        });
    }
    ...
    updateSR(srId) {
        return __awaiter(this, void 0, void 0, function* () {
            return index_1.db.ServiceRequest.update({ Status: 4 }, { where: { ServiceRequestId: srId } });
        });
    }
