...
class Contact_UsRepository {
    getContact_UsById(contact_usId) {
        return __awaiter(this, void 0, void 0, function* () {
            return index_1.db.Contact_Us.findOne({ where: { id: contact_usId } });
        });
    }
    getContact_Us() {
        return __awaiter(this, void 0, void 0, function* () {
    ...
    updateContact_Us(users, contact_usId) {
        return __awaiter(this, void 0, void 0, function* () {
            return index_1.db.Contact_Us.update(users, { where: { id: contact_usId } });
        });
    }
    deleteContact_Us(contact_usId) {
        return __awaiter(this, void 0, void 0, function* () {
            return index_1.db.Contact_Us.destroy({ where: { id: contact_usId } });
        });
    }
}
