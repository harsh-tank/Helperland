...
router.put("/update_detail_by_id",celebrate(User_Update),loginController.authenticateToken,mySettingsController.update_User_DetailById);
router.post("/create_user_add",celebrate(Create_or_Update_Add),loginController.authenticateToken,mySettingsController.create_Add);
router.put("/del_user_add/:addressId",loginController.authenticateToken,mySettingsController.delete_Add);
router.put("/reset_pass_user",celebrate(Reset_Pass),loginController.authenticateToken,mySettingsController.change_Pass);
